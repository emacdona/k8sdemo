...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Selects at random from a list of 280 Subreddits.
            \item The list never changes.
            \item It doesn't need to store anything anywhere.
        \end{itemize}
        \item One is stateful:
        \begin{itemize}
            \item Selects at random from a list of Subreddits.
            \item \textbf{Removes} the selected Subreddit from the list.
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Replaced if unresponsive.
            \item Can be deleted on one Node and added on another (moved).
            \item \textbf{You cannot prevent either of these things from happening.}
        \end{itemize}
        \item By default, Volumes don't follow Pods.
        \item By default, hostnames don't follow Pods.
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item I'm not going to use those features.
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item ``Persistent" here means they ``follow" Pods.
